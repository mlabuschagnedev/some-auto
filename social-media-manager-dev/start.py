...
def _configure_public_base_url() -> subprocess.Popen | None:
    ...
    if current_public_base and "trycloudflare.com" not in current_public_base:
        return None
...
# Development-copy defaults.
# You can still override these values in your terminal before running.
os.environ.setdefault("PORT", "5555")
os.environ.setdefault("AUTO_TRYCLOUDFLARE_TUNNEL", "0")
